...
/**
 * Represents the JavaScript callback `(planeId: string) => void`.
...
fun interface Func_void_std__string: (String) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(planeId: String): Unit
}
...
class Func_void_std__string_cxx: Func_void_std__string {
  ...
  private external fun invoke_cxx(planeId: String): Unit
}
