...
/**
 * Wraps a Swift `(_ planeId: String) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_std__string {
  public typealias bridge = margelo.nitro.munimxr.bridge.swift

  private let closure: (_ planeId: String) -> Void

  public init(_ closure: @escaping (_ planeId: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(planeId: std.string) -> Void {
    self.closure(String(planeId))
  }
